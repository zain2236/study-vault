...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f0] dark:bg-gray-800 flex items-center justify-center px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-md w-full relative z-10">
        {/* Login Card */}
        <Form method="post" className="bg-white dark:bg-gray-700 rounded-2xl shadow-2xl p-8 sm:p-10 space-y-5">
