      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        ...
        <Form method="post" className="bg-white rounded-2xl shadow-2xl p-8 space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm">
              <a href="#" className="font-semibold text-[#d97757] hover:text-[#c66847] transition-colors">
                Forgot password?
              </a>
            </div>
          </div>
        ...
        <div className="text-center">
          <p className="text-gray-600">
            ...
            <Link to="/sign-up" className="font-semibold text-[#d97757] hover:text-[#c66847] transition-colors">
              Sign up for free
            </Link>
          </p>
        </div>
        ...
        <div className="text-center">
          <p className="text-sm text-gray-500">
            ...
            <a href="#" className="text-[#d97757] hover:underline">Terms</a>
            {' '}and{' '}
            <a href="#" className="text-[#d97757] hover:underline">Privacy Policy</a>
          </p>
        </div>
      </div>
    </div>
